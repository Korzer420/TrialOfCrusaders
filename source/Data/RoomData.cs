...
public class RoomData
{
    ...
    internal bool Available(bool easyMode, Progress progress)
    {
        if (BossRoom)
        {
            ...
            {
                Progress.None => true,
                Progress.Dash => progress.HasFlag(Progress.Dash | Progress.Fireball) || progress.HasFlag(Progress.Dash | Progress.Quake),
                Progress.Claw => progress.HasFlag(Progress.ShadeCloak | Progress.Wings | Progress.Fireball) || progress.HasFlag(Progress.ShadeCloak | Progress.Wings | Progress.Quake),
