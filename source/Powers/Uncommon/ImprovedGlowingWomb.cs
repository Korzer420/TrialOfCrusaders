...
internal class ImprovedGlowingWomb : Power
{
    ...
    public override string Name => "Improved Glowing Womb";

    public override string Description => "Hatchlings no longer costs soul. Damage is increased.";
    ...
    protected override void Enable()
    {
        ...
        HatchlingVariables.FindFsmInt("Soul Cost").Value = 0;
